...
function(springbok_static_module)
  ...
  list(APPEND _COMPILER_ARGS "--iree-llvm-target-triple=riscv32-unknown-elf")
  list(APPEND _COMPILER_ARGS "--iree-llvm-target-cpu=generic-rv32")
  list(APPEND _COMPILER_ARGS "--iree-llvm-target-cpu-features=+m,+f,+d,+zfh")
  list(APPEND _COMPILER_ARGS "--iree-llvm-target-abi=ilp32d")
